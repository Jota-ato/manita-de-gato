...
export const metadata: Metadata = {
  ...
  description:
    "Lista de usuarios registrados en la aplicación. Administra y gestiona los usuarios, sus roles y permisos desde esta página.",
};
  ...
  return (
    <section className="min-h-screen py-8 md:py-12">
      <Container className="space-y-8">
        ...
        <UsersTable currentUser={user as UserWithProvider} users={users} />
      </Container>
      <DeleteDialog currentUser={user as User} />
      <EditDialog currentUser={user as User} />
    </section>
  );
}
