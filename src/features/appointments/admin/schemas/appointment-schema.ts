...
export const newAppointmentManuallySchema = z
  .discriminatedUnion("isRegisterClient", [
...
export const blockTimeSchema = baseAppointmentSchema
  .pick({
    startTime: true,
    endTime: true,
  })
...
export type NewAppointmentManuallyInput = z.infer<
  typeof newAppointmentManuallySchema
>;
