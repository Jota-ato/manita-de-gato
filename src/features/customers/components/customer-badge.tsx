...
const tierConfig: Record<ActivityTier, { label: string; className: string }> = {
    frequent: { label: "Frecuente", className: "bg-success/10 text-success border-success/20" },
    regular: { label: "Regular", className: "bg-primary/10 text-primary border-primary/20" },
    occasional: { label: "Ocasional", className: "bg-secondary/10 text-secondary-foreground border-secondary/20" },
    new: { label: "Nuevo", className: "bg-muted text-muted-foreground border-border" },
}
